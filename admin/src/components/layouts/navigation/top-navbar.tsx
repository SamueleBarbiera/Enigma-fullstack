        ...
        <header className="fixed z-40 w-full bg-white shadow">
            <nav className="flex items-center justify-between px-5 py-4 md:px-8">
                ...
                <motion.button
                    ...
                    className="flex h-full items-center justify-center pe-2 focus:text-accent focus:outline-none lg:hidden"
                >
                    <NavbarIcon />
                </motion.button>
                ...
                <div className="flex items-center space-s-5 lg:space-s-8">
                    {hasAccess(adminAndOwnerOnly, permissions) && (
                        <LinkButton href={ROUTES.CREATE_SHOP} className="ms-4 md:ms-6" size="small">
