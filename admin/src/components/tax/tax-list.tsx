...
const TaxList = ({ taxes, onSort, onOrder }: IProps) => {
    ...
    const columns: readonly (ColumnGroupType<Tax> | ColumnType<Tax>)[] = [
        ...
        },
        {
            title: (
                <TitleWithSort
                    ...
                    ascending={sortingObj.sort === SortOrder.Asc && sortingObj.column === 'rate'}
        ...
        },
        {
            title: (
                <TitleWithSort
                    ...
                    ascending={sortingObj.sort === SortOrder.Asc && sortingObj.column === 'country'}
        ...
        },
        {
            ...
            align: 'center',
            render: (id: string) => (
                <ActionButtons id={id} editUrl={`${ROUTES.TAXES}/edit/${id}`} deleteModalView="DELETE_TAX" />
            ),
            width: 200,
        },
    ]
