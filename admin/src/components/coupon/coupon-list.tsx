...
import { Coupon, CouponPaginator, SortOrder } from '@ts-types/generated'
        ...
        },
        {
            title: (
                <TitleWithSort
                    ...
                    ascending={sortingObj.sort === SortOrder.Asc && sortingObj.column === 'code'}
        ...
        },
        {
            title: (
                <TitleWithSort
                    ...
                    ascending={sortingObj.sort === SortOrder.Asc && sortingObj.column === 'active_from'}
            ...
            render: (active_date: string) => (
                <span className="whitespace-nowrap">{dayjs().to(dayjs.utc(active_date).tz(dayjs.tz.guess()))}</span>
            ),
        },
        {
            title: (
                <TitleWithSort
                    ...
                    ascending={sortingObj.sort === SortOrder.Asc && sortingObj.column === 'expire_at'}
            ...
            render: (expired_date: string) => (
                <span className="whitespace-nowrap">{dayjs().to(dayjs.utc(expired_date).tz(dayjs.tz.guess()))}</span>
            ),
        },
        {
            ...
            align: 'center',
            render: (id: string) => (
                <ActionButtons id={id} editUrl={`${ROUTES.COUPONS}/edit/${id}`} deleteModalView="DELETE_COUPON" />
            ),
        },
    ]
