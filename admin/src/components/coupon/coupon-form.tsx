    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}>
            <div className='flex flex-wrap pb-8 border-b border-dashed border-border-base my-5 sm:my-8'>
                <Description title={t('form:input-label-image')} details={t('form:coupon-image-helper-text')} className='w-full px-0 sm:pe-4 md:pe-5 pb-5 sm:w-4/12 md:w-1/3 sm:py-8' />
            ...
            <div className='flex flex-wrap my-5 sm:my-8'>
                ...
                <Card className='w-full sm:w-8/12 md:w-2/3'>
                    <Input label={t('form:input-label-code')} {...register('code')} error={t(errors.?.message!)} variant='outline' className='mb-5' />

                    <TextArea label={t('form:input-label-description')} {...register('description')} variant='outline' className='mb-5' />
                    {couponType !== CouponType.FreeShippingCoupon && (
                        <Input label={`${t('form:input-label-amount')}(${currency})`} {...register('amount')} type='number' error={t(errors.amount?.message!)} variant='outline' className='mb-5' />
                    )}
            ...
            <div className='mb-4 text-end'>
                ...
                <Button loading={updating || creating}>{initialValues ? t('form:button-label-update-coupon') : t('form:button-label-add-coupon')}</Button>
            </div>
        </form>
    )
}
