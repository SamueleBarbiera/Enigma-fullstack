...
export default function ImportProducts() {
    ...
    const { mutate: importProducts, isLoading: loading } = useImportProductsMutation()
    ...
    return <ImportCsv onDrop={handleDrop} loading={loading} title={t('text-import-products')} />
}
