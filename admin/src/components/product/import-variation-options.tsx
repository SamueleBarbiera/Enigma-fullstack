...
export default function ImportVariationOptions() {
    ...
    const { mutate: importVariationOptions, isLoading: loading } = useImportVariationOptionsMutation()
    ...
    return <ImportCsv onDrop={handleDrop} loading={loading} title={t('text-import-product-variations')} />
}
