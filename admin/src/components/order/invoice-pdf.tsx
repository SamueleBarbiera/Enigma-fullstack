...
import { Order, Product } from '@ts-types/generated'
            ...
            <Page size="A4">
                <View style={styles.container}>
                    ...
                    <View style={styles.totalCountWrapper}>
                        ...
                        <View style={styles.totalCountRow}>
                            <Text style={styles.totalCountCell}>Costi di spedizione</Text>
                            <Text style={styles.totalCountCell}>{delivery_fee}</Text>
                        </View>
                        <View style={styles.totalCountRow}>
                            <Text style={[styles.totalCountCell, { fontSize: 12 }]}>Total</Text>
                            <Text style={[styles.totalCountCell, { fontSize: 12 }]}>{total}</Text>
                        </View>
                    </View>
                </View>
