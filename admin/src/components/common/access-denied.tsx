...
const AccessDeniedPage = () => {
    ...
    return (
        <div className="flex min-h-screen w-full flex-col items-center justify-center p-4 sm:p-8">
            <div className="relative flex h-80 w-full justify-center sm:h-96 3xl:h-[580px]">
                <Image alt={t('text-access-denied')} src="/access-denied.svg" height={580} width={1000} />
            </div>
            ...
            <p className="mt-2 text-center text-sm text-body 3xl:text-xl">
                ...
                <Link href="/" className="text-accent transition-colors ps-1 hover:text-accent-hover">
                    {t('text-return-home')}
                </Link>
            </p>
        </div>
