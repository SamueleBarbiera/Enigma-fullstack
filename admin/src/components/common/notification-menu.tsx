...
const NotificationMenu: React.FC<MenuType> = ({ data }: MenuType) => {
                    ...
                    {isOpen && (
                        ...
                        >
                            <div className="flex items-center justify-between border-b border-border-200 px-4 py-3">
                                <span className="text-lg font-semibold text-heading">Notification</span>
                            ...
                            {data.length ? (
                                ...
                                <div className="flex items-center justify-center border-b border-border-200 bg-light">
                                    <p className="py-5 text-sm text-body">You don't have any notifications.</p>
                                </div>
                            )}
