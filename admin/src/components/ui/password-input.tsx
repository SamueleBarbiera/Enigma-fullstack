            ...
            <div className={className}>
                <div className="mb-3 flex items-center justify-between">
                    ...
                    {forgotPageLink && forgotPassHelpText && (
                        <Link
                            href={forgotPageLink}
                            className="text-xs text-accent transition-colors duration-200 hover:text-accent-hover focus:font-semibold focus:text-accent-hover focus:outline-none"
                        >
                            {forgotPassHelpText}
                        </Link>
                    )}
                ...
                {error && <p className="my-2 text-start text-xs text-red-500">{error}</p>}
            </div>
        )
    }
)
