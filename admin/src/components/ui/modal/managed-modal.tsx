...
const UserWalletPointsAddView = dynamic(() => import('@components/user/user-wallet-points-add-view'))
...
const TypeDeleteView = dynamic(() => import('@components/brand/brand-delete-view'))
