        ...
        return (
            <div className={className}>
                <div className="flex h-full w-full">
                    ...
                    <label htmlFor={id} className="flex w-full cursor-pointer flex-col rounded border border-gray-200">
                ...
                {errorKey && <p className="my-2 text-start text-xs text-red-500">{t(errorKey)}</p>}
            </div>
        )
    }
)
