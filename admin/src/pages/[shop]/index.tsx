        ...
        <div className="grid grid-cols-12 gap-6">
                ...
                <div className="flex flex-col items-center rounded bg-white py-8 px-6">
                    ...
                    <div className="mt-5 flex w-full justify-start">
                        ...
                        <address className="text-sm not-italic text-body">
                            {!isEmpty(formatAddress(address!)) ? formatAddress(address!) : t('common:text-no-address')}
                        </address>
                    </div>
                    ...
                    <div className="mt-3 flex w-full justify-start">
                        ...
                        <a href={`tel:${settings?.contact ?? ''}`} className="text-sm text-body">
                            {settings?.contact ? settings.contact : t('common:text-no-contact')}
                        </a>
                    </div>
            ...
            <div className="order-4 col-span-12 xl:order-3 xl:col-span-9">
                <div className="grid h-full grid-cols-1 gap-5 rounded bg-light p-4 md:grid-cols-3">
                    <div className="space-y-3">
                        <h2 className="text-lg font-semibold text-heading">{t('common:text-products')}</h2>
                        ...
                        <div className="border border-gray-100">
                            <div className="flex items-center border-b border-gray-100 py-3 px-4">
                                ...
                                <div className="ml-3">
                                    <p className="mb-0.5 text-lg font-semibold text-sub-heading">{products_count}</p>
                                    <p className="mt-0 text-sm text-muted">{t('common:text-total-products')}</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center py-3 px-4">
                                ...
                                <div className="ml-3">
                                    <p className="mb-0.5 text-lg font-semibold text-sub-heading">{orders_count}</p>
                                    <p className="mt-0 text-sm text-muted">{t('common:text-total-orders')}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-3">
                        <h2 className="text-lg font-semibold text-heading">{t('common:text-revenue')}</h2>
                    ...
                    <div className="space-y-3">
                        <h2 className="text-lg font-semibold text-heading">{t('common:text-others')}</h2>
                        ...
                        <div className="border border-gray-100">
                            <div className="flex items-center border-b border-gray-100 py-3 px-4">
                                ...
                                <div className="ml-3">
                                    ...
                                    <p className="mt-0 text-sm text-muted">{t('common:text-commission-rate')}</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className="order-3 col-span-12 rounded bg-light sm:col-span-6 xl:order-4 xl:col-span-3">
                ...
                <div className="flex flex-col p-6 2xl:p-7">
                    <span className="mb-4 text-lg font-semibold text-sub-heading">{t('common:text-payment-info')}</span>

                    <div className="flex flex-col space-y-3">
                        <p className="text-sm text-sub-heading">
                            <span className="block w-full text-muted">{t('common:text-name')}:</span>{' '}
                            <span className="font-semibold">{balance?.payment_info?.name}</span>
                        </p>
                        <p className="text-sm text-sub-heading">
                            <span className="block w-full text-muted">{t('common:text-email')}:</span>{' '}
                            <span className="font-semibold">{balance?.payment_info?.email}</span>
                        </p>
                        <p className="text-sm text-sub-heading">
                            <span className="block w-full text-muted">{t('common:text-bank')}:</span>{' '}
                            <span className="font-semibold">{balance?.payment_info?.bank}</span>
                        </p>
                        <p className="text-sm text-sub-heading">
                            <span className="block w-full text-muted">{t('common:text-account-no')}:</span>{' '}
                            <span className="font-semibold">{balance?.payment_info?.account}</span>
                        </p>
                    </div>
                </div>
            </div>
