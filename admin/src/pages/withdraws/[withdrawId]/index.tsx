...
const Withdraw = () => {
    ...
    const { data, error, isLoading: loading } = useWithdrawQuery(withdrawId as string)
                            ...
                            <div className="w-full md:order-1 md:w-1/2 md:pe-3">
                                <div className="mb-2 flex items-center justify-start">
                                    ...
                                    <div className="flex w-full items-center rounded border border-gray-300 px-4 py-3 xl:w-5/12">
                                        <span className="font-semibold text-heading">{data?.withdraw.amount}</span>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center">
                                    ...
                                    <span className="w-full text-sm font-semibold text-heading">
                                        {WithdrawStatus.find((status) => status.id === data?.withdraw.status)?.name}
                                    </span>
                                </div>
                            </div>
                        </div>
