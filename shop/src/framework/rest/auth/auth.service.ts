...
class Auth extends CoreApi {
    ...
    socialLogin(input: SocialLoginInputType) {
        return this.http.post(API_ENDPOINTS.SOCIAL_LOGIN, input).then((res) => res.data)
    }
    sendOtpCode(input: SendOtpCodeInputType) {
        return this.http.post(API_ENDPOINTS.SEND_OTP_CODE, input).then((res) => res.data)
    }
    verifyOtpCode(input: VerifyOtpInputType) {
        return this.http.post(API_ENDPOINTS.VERIFY_OTP_CODE, input).then((res) => res.data)
    }
    otpLogin(input: OtpLoginInputType) {
        return this.http.post(API_ENDPOINTS.OTP_LOGIN, input).then((res) => res.data)
    }
    updateContact(input: UpdateContactInput) {
        return this.http.post(API_ENDPOINTS.UPDATE_CONTACT, input).then((res) => res.data)
    }
    ...
    changePassword(input: ChangePasswordInputType) {
        return this.http.post(API_ENDPOINTS.CHANGE_PASSWORD, input).then((res) => res.data)
    }
    forgetPassword(input: ForgetPasswordInputType) {
        return this.http.post(API_ENDPOINTS.FORGET_PASSWORD, input).then((res) => res.data)
    }
    resetPassword(input: ResetPasswordInputType) {
        return this.http.post(API_ENDPOINTS.RESET_PASSWORD, input).then((res) => res.data)
    }
    verifyForgetPassword(input: VerifyPasswordInputType) {
        return this.http.post(API_ENDPOINTS.VERIFY_FORGET_PASSWORD, input).then((res) => res.data)
    }
}
