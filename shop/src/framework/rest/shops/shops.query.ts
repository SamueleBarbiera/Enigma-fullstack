...
const useShopsQuery = (
    ...
    options?: UseInfiniteQueryOptions<PaginatedShop, Error, PaginatedShop, PaginatedShop, QueryKey>
) => {
    return useInfiniteQuery<PaginatedShop, Error>([API_ENDPOINTS.SHOPS, params], fetchShops, {
        ...options,
...
export const useShopQuery = (slug: string) => {
    return useQuery<Shop, Error>([API_ENDPOINTS.SHOPS, slug], () => fetchShop(slug))
}
