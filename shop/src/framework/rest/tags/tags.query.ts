...
const fetchTags = async ({ queryKey, pageParam }: QueryParamsType): Promise<PaginatedTag> => {
...
const useTagsQuery = (
    ...
    options?: UseInfiniteQueryOptions<PaginatedTag, Error, PaginatedTag, PaginatedTag, QueryKey>
) => {
    return useInfiniteQuery<PaginatedTag, Error>([API_ENDPOINTS.TAGS, params], fetchTags, {
        ...options,
