...
import { useSendOtpCodeMutation, useVerifyOtpCodeMutation } from '@framework/auth/auth.query'
        ...
        <>
            {!hasOTP ? (
                ...
                <div className="w-full flex flex-col md:flex-row md:items-center md:space-x-5">
                    ...
                    />
                    <Button loading={otpVerifyLoading} disabled={otpVerifyLoading} onClick={onVerifyCodeSubmission}>
                        {t('text-verify-code')}
                    </Button>
                </div>
            )}
