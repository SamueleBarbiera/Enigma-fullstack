import { QueryParamsType, Type, TypeQueryOptionsType } from '@framework/types'
...
export const useBrandsInfiniteQuery = (
    ...
    options?: UseInfiniteQueryOptions<PaginatedTypes, Error, PaginatedTypes, PaginatedTypes, QueryKey>
) => {
    return useInfiniteQuery<PaginatedTypes, Error>([API_ENDPOINTS.TYPE, params], fetchInfiniteBrands, {
        ...options,
...
export const useBrandsQuery = (options: TypeQueryOptionsType) => {
    return useQuery<{ data: Type[] }, Error>([API_ENDPOINTS.TYPE, options], fetchBrands)
}
...
export const useBrandQuery = (slug: string) => {
    return useQuery<{ type: Type }, Error>([API_ENDPOINTS.TYPE, slug], () => fetchBrand(slug), {
