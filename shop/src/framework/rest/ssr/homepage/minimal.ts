...
export const getStaticProps: GetStaticProps = async ({ locale }) => {
    ...
    try {
        await Promise.all([
            ...
            await queryClient.prefetchQuery([API_ENDPOINTS.CATEGORIES, { limit: 10, parent: null }], fetchCategories),

            // Featured Categories
            await queryClient.prefetchQuery([API_ENDPOINTS.FEATURED_CATEGORIES, { limit: 3 }], fetchFeaturedCategories),
            ...
            await queryClient.prefetchQuery([API_ENDPOINTS.TYPE, { limit: 16 }], fetchBrands),
        ])
