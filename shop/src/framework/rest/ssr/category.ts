...
import { fetchCategories, fetchCategory } from '@framework/category/categories.query'
...
export const getStaticProps: GetStaticProps = async ({ params, locale }) => {
    ...
    try {
        await Promise.all([
            ...
            await queryClient.prefetchQuery([API_ENDPOINTS.CATEGORIES, slug], () => fetchCategory(slug)),
