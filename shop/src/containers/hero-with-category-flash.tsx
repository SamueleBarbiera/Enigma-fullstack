...
const HeroWithCategoryFlash: React.FC<Props> = ({ className = 'mb-12 md:mb-14 xl:mb-16', data }) => {
    return (
        <div className={`grid grid-cols-1 lg:grid-cols-7 2xl:grid-cols-9 gap-5 xl:gap-7 lg:gap-y-14 ${className}`}>
