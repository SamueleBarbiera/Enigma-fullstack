    ...
    return (
        <>
            <Container>
                ...
                <ProductsFeatured sectionHeading="text-featured-products" variant="fashion" limit={6} />

                <BannerBlock data={fashionSaleBannerData} className="mb-12 md:mb-14 xl:mb-16 hidden sm:flex" />
