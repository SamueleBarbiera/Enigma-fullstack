...
import { homeElegantHeroSlider as heroBanner, elegantBannerDataThree, elegantHomeBanner } from '@data/static/banners'
...
export default function Home() {
    return (
        <>
            ...
            <Container>
                <BannerBlock data={elegantBannerDataThree} className="mb-12 md:mb-14 xl:mb-16" />
                <CategoryBlock
                    ...
                    type="vector"
                />
                <ProductsFeatured sectionHeading="text-featured-products" variant="combined" limit={4} />
