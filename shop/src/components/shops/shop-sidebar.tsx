    ...
    return (
        <div className={cn('flex flex-col pt-10 lg:pt-14 px-6', className)}>
            ...
            <div className="space-y-6 py-7">
                {/* Address */}
                <div className="block">
                    <h4 className="text-heading font-semibold text-sm mb-1.5">{t('text-address-colon')}</h4>
                ...
                {data?.settings?.website && (
                    <div className="block">
                        <h4 className="text-heading font-semibold text-sm mb-1.5">{t('text-website-colon')}</h4>
                        <div className="flex items-center justify-between">
