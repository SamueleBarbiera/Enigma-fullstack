...
const addressSchema = yup.object().shape({
    type: yup.string().oneOf([AddressType.Billing, AddressType.Shipping]).required('error-type-required'),
...
const AddressForm: React.FC<any> = ({ data }) => {
    ...
    return (
        <div className="p-5 sm:p-8 md:rounded-xl min-h-screen md:min-h-0 bg-white">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-2 gap-5 h-full">
                <div>
