...
const AddressCard: React.FC<AddressProps> = ({ checked, address, userId }) => {
    ...
    return (
        ...
        >
            <p className="text-base text-heading font-semibold mb-2 md:mb-3 capitalize">{address.title}</p>
            <p className="text-sm text-body leading-6">{formatAddress(address.address)}</p>
