...
import { billingAddressAtom, shippingAddressAtom, verifiedResponseAtom } from '@store/checkout'
...
export const CheckAvailabilityAction = (props) => {
    ...
    const { mutate: verifyCheckout, isLoading: loading } = useVerifyCheckoutMutation()
    ...
    return (
        <>
            <Button loading={loading} className="w-full" onClick={handleVerifyCheckout} disabled={isEmpty} {...props} />
            {errorMessage && (
                <div className="mt-3">
