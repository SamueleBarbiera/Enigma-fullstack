...
export const AccountAddress: React.FC<AddressesProps> = ({ addresses, label, className, userId }) => {
                ...
                {addresses && addresses?.length ? (
                    <>
                        {addresses?.map((address) => (
                            <AddressCard checked={false} address={address} userId={userId} key={address.id} />
                        ))}
                    </>
                ) : (
