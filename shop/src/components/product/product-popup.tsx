            ...
            <div className="flex flex-col lg:flex-row w-full md:w-[650px] lg:w-[960px] mx-auto overflow-hidden">
                <div className="flex-shrink-0 flex items-center justify-center w-full lg:w-430px max-h-430px lg:max-h-full overflow-hidden bg-gray-300">
                    <Image
                        width={430}
                        height={558}
                        src={product?.image?.original ?? '/assets/placeholder/products/product-thumbnail.svg'}
                        alt={product.name}
                ...
                <div className="flex flex-col p-5 md:p-8 w-full">
                    <div className="pb-5">
                        ...
                        {product.unit && isEmpty(variations) && (
                            <span className="text-sm font-normal text-body mt-2 md:mt-3 block">{product.unit}</span>
                        )}

                        <p className="text-sm leading-6 md:text-body md:leading-7">{product.description}</p>
