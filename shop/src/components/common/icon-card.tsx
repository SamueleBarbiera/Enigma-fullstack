...
const IconCard: React.FC<Props> = ({ item, effectActive = false, variant = 'default' }) => {
    ...
    return (
        <Link
            ...
            className={cn('group flex justify-center flex-col rounded-lg', {
                'h-28 sm:h-[8.5rem] md:h-40 xl:h-[11.5rem] 2xl:h-44 3xl:h-60 bg-gray-200': variant === 'default',
                'px-6 lg:px-8 pt-7 lg:pt-10 pb-5 lg:pb-8 bg-gray-200': variant === 'modern',
            ...
            <div>
                ...
                <div
                    className={cn('relative flex items-center', {
                        'mb-3.5 md:mb-4 lg:mb-5 xl:mb-2 2xl:mb-6 3xl:mb-8 lg:h-24 mx-auto': variant === 'default',
                ...
                >
                    <img
                        ...
                        className={cn('mb-0', {
                            'mx-auto mb-4 sm:mb-6 w-2/4 sm:w-2/3 md:w-8/12 3xl:w-full': variant === 'default',
                            'mb-4 sm:mb-6 w-2/4': variant === 'modern',
                            'transform scale-[0.6] lg:scale-75 2xl:scale-85 3xl:scale-90': variant === 'circle',
                        })}
                    />
