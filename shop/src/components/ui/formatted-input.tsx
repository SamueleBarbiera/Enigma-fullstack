...
const variantClasses = {
    normal: 'bg-gray-100 border border-gray-300 focus:shadow focus:bg-white focus:border-black',
...
const FormattedInput = forwardRef<HTMLInputElement, FormattedInputProps>(({name, label, error, options, variant = 'normal', className, inputClassName, shadow = false, ...rest}, ref) => {
    return (
