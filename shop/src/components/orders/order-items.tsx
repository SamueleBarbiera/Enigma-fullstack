        ...
        <div className="flex items-center">
            ...
            <div className="flex flex-col ltr:ml-4 rtl:mr-4 overflow-hidden">
                <div className="flex mb-2 text-body">
                    <span className="text-[15px] truncate inline-block overflow-hidden">{name} x&nbsp;</span>
...
export const OrderItems = ({ products }: { products: any }) => {
    ...
    const orderTableColumns: readonly (ColumnGroupType<any> | ColumnType<any>)[] = [
        {
        ...
        },
        {
            ...
            render: function renderQuantity(pivot: any) {
                return <p className="text-[15px] md:text-base font-semibold text-heading">{pivot.order_quantity}</p>
            },
        },
        {
            title: t('text-price'),
            ...
            render: function RenderPrice(pivot: any) {
                ...
                return <p className="text-[15px] md:text-base font-semibold text-heading">{price}</p>
            },
        },
    ]
