            ...
            <div className="w-full mx-auto shadow-sm">
                ...
                <div className="grid gap-4 lg:gap-5 sm:grid-cols-2 lg:grid-cols-4 mb-11">
                    <div className="p-5 md:p-6 border border-gray-100 bg-gray-200 rounded-md shadow-sm">
                        <h3 className="mb-2 text-base text-heading font-semibold">{t('text-order-number')}</h3>
                        <p className="text-sm text-body">{order?.tracking_number}</p>
                    </div>
                    <div className="p-5 md:p-6 border border-gray-100 bg-gray-200 rounded-md shadow-sm">
                        <h3 className="mb-2 text-base text-heading font-semibold">{t('text-date')}</h3>
                        <p className="text-sm text-body">{dayjs(order?.created_at).format('MMMM D, YYYY')}</p>
                    </div>
                    <div className="p-5 md:p-6 border border-gray-100 bg-gray-200 rounded-md shadow-sm">
                        <h3 className="mb-2 text-base text-heading font-semibold">{t('text-total')}</h3>
                        <p className="text-sm text-body">{total}</p>
                    </div>
                    <div className="p-5 md:p-6 border border-gray-100 bg-gray-200 rounded-md shadow-sm">
                        <h3 className="mb-2 text-base text-heading font-semibold">{t('text-payment-method')}</h3>
                        <p className="text-sm text-body">{order?.payment_gateway ?? 'N/A'}</p>
                    </div>
                </div>
                    ...
                    <div className="w-full md:w-1/2 px-5 lg:px-7 py-6 lg:py-7 xl:py-8">
                        ...
                        <div className="space-y-4 lg:space-y-5">
                            ...
                            <p className="flex text-body text-sm lg:text-[15px] xl:text-base mb-0">
                                ...
                                :<span className="w-1/2 md:w-8/12 ltr:pl-7 rtl:pr-7">{order?.delivery_time}</span>
                            </p>
                            <p className="flex text-body text-sm lg:text-[15px] xl:text-base mb-0">
                                <strong className="w-1/2 md:w-4/12 ltr:pr-4 rtl:pl-4 text-heading font-semibold">
                        ...
                        <div>
                            <div className="flex items-start mb-6">
                                <p className="text-heading text-sm leading-6">
                                    <span className="font-bold">{t('text-note')}:</span> {t('text-message-sub-order')}
                                </p>
                            </div>
